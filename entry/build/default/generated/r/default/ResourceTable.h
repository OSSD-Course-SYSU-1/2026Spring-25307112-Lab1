...
const int32_t STRING_PERMISSION_READ_IMAGE_REASON = 0x0100000f;
const int32_t COLOR_START_WINDOW_BACKGROUND = 0x01000007;
const int32_t FLOAT_PAGE_TEXT_FONT_SIZE = 0x01000008;
const int32_t MEDIA_AVATAR1 = 0x01000009;
const int32_t MEDIA_AVATAR2 = 0x0100000a;
const int32_t MEDIA_BACKGROUND = 0x01000001;
const int32_t MEDIA_FILTER_IMAGE = 0x0100000b;
